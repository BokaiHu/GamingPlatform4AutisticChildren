<template>
  <div class="content">
    ...
    <div class="main-container">
      ...
      <div class="hint">
        <img
          src="\src\assets\puzzles\SydneyOperaHouse.jfif"
    ...
    <transition>
      <div class="popup-window" v-if="isPuzzleComplete & !HideNotShow">
        ...
        <button class="btn" @click="HideNotShow = true">{{ $t("ToOceania") }}</button>
      </div>
    </transition>
    <transition>
      <div class="popup-window" v-if="isPuzzleComplete & HideNotShow">
        <Complete msg="sydney" @close="isPuzzleComplete=false, HideNotShow=false" @navigate="navigateTo('OC')"></Complete>
      </div>
    </transition>
...
.image_sydney{
    width: 160px;
    height: 160px;
    background-image: url("/src/assets/puzzles/SydneyOperaHouse.jfif");
