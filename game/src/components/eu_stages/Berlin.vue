<template>
  <div class="content">
    ...
    <div class="main-container">
      ...
      <div class="hint">
        <img
          src="\src\assets\puzzles\brandenburg_gate.jpg"
    ...
    <transition>
      <div class="popup-window" v-if="isPuzzleComplete & showCar">
        <Complete msg="germanCar0" @close="showCar=false" @navigate="navigateTo('EU')"></Complete>
      </div>
    </transition>
    <transition>
      <div class="popup-window" v-if="isPuzzleComplete & showCuisine">
        <Complete msg="germanCuisine0" @close="showCuisine=false" @navigate="navigateTo('EU')"></Complete>
      </div>
    </transition>
    <transition>
    ...
    <transition>
      <div class="popup-window" v-if="isPuzzleComplete & showCurrency">
        <Complete msg="germanCurrency0" @close="showCurrency=false" @navigate="navigateTo('EU')"></Complete>
      </div>
    </transition>
...
.image_berlin{
  width: 160px;
  height: 160px;
  background-image: url("/src/assets/puzzles/brandenburg_gate.jpg");
