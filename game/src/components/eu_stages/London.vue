<template>
  <div class="content">
    ...
    <div class="main-container">
      ...
      <div class="hint">
        <img
          src="\src\assets\puzzles\big_ben.jpg"
    ...
    <transition>
      <div class="popup-window" v-if="isPuzzleComplete & showCar">
        <Complete msg="britishCar" @close="showCar=false" @navigate="navigateTo('EU')"></Complete>
      </div>
    </transition>
    <transition>
      <div class="popup-window" v-if="isPuzzleComplete & showCuisine">
        <Complete msg="britishCuisine" @close="showCuisine=false" @navigate="navigateTo('EU')"></Complete>
      </div>
    </transition>
    <transition>
      <div class="popup-window" v-if="isPuzzleComplete & showFlower">
        <Complete msg="britishFlower" @close="showFlower=false" @navigate="navigateTo('EU')"></Complete>
      </div>
    </transition>
    <transition>
      <div class="popup-window" v-if="isPuzzleComplete & showCurrency">
        <Complete msg="britishCurrency" @close="showCurrency=false" @navigate="navigateTo('EU')"></Complete>
      </div>
    </transition>
...
.image_london{
    width: 160px;
    height: 160px;
    background-image: url("/src/assets/puzzles/big_ben1.jpg");
